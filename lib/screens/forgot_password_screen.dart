...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Forgot password', style: TextStyle(fontWeight: FontWeight.w900))),
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SizedBox(height: 12),
              Text('Reset your password', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 24)),
              SizedBox(height: 8),
          ...
          FilledButton(onPressed: submitting ? null : submit, child: Text(submitting ? 'Sending...' : 'Send reset link')),
          TextButton(
  ...
  Future<void> submit() async {
    ...
    try {
      final result = await context.read<AppState>().authService.forgotPassword(email.text.trim());
